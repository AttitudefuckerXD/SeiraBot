...
from SeiraRobot.services.keyboard import Ikb
from SeiraRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from SeiraRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from SeiraRobot.services.types import InlineQueryResultCachedDocument
from SeiraRobot.modules.info import get_chat_info, get_user_info
from SeiraRobot.modules.music import download_youtube_audio
from SeiraRobot.utils.functions import test_speedtest
from SeiraRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/a01ef91bd802109bbcbc1.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/DevilxAngeLBot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[DevilAngel ❤️](https://t.me/DevilxAngeLBot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/attiude_king_vj)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
